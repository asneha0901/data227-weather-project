...
st.header("5) Distribution of Different Weather Days")
st.write("This is the static chart I am including to the story: It is supposed to show how frequent different types of days are in relation to each other.")
st.altair_chart(chart_weather_type(df), use_container_width=True)
st.caption("Takeaway: Sunny days are the most common, followed by fog: something most characteristic of Seattle")
